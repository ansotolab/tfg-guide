...
import es.ansotolab.customersservice.exception.CustomerAlreadyExists;
import es.ansotolab.customersservice.exception.CustomerHasNotBeenDeleted;
import es.ansotolab.customersservice.exception.CustomerNotFound;
import es.ansotolab.customersservice.model.Customer;
import es.ansotolab.customersservice.model.ProductDetail;
import es.ansotolab.customersservice.repository.CustomerRepository;
